...
public class KcityController extends HttpServlet {
	...
	private CityDao cDao = new CityDao();		// <-- 이미 CityDao가 선언이 되어있기 때문에 밑에는 따로 선언x
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String district = null, name = null, countryCode = null, population_ = null;
		...
		case "list":
			...
			int num = (num_ == null || num_.equals("")) ? 80 : Integer.parseInt(num_);
		...
		case "delete":
			id = Integer.parseInt(request.getParameter("id"));
			cDao.deleteCity(id);
			response.sendRedirect("/jw/ch07/kcity/list?district=Kyonggi&limit=80&offset=0");
			break;
