...
<%@ include file="../common/_top.jspf" %>
    <div class="container">
        ...
        <form action="/jw/auction/ski_equipment/update" method="post">
            ...
            <input type="text" id="equipmentName" name="equipmentId" value="${equipment.equipmentId}">
            <label for="userId">사용자 ID:</label>
            <input type="text" id="userId" name="userId" value="${equipment.userId}" disabled="disabled">
