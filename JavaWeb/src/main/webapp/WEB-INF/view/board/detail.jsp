			...
			<div class="col-9">
				<h3><strong class="me-5">게시글 보기</strong>
					<span style="font-size:16px">
						<a href="/jw/bbs/board/list?p=${currentBoardPage}&f=${field}&q=${query}"><i class="fa-solid fa-list-ol"></i> 목록</a>
					<c:if test="${sessUid eq board.uid}">	<!--  본인만 수정/삭제 가능 -->
						...
						<a href="javascript:deleteFunc('${board.bid}')"><i class="fa-solid fa-trash-can ms-3"></i> 삭제</a>
						
					</c:if>
					<c:if test="${sessUid ne board.uid}">	<!--  아닌 사람 -->
						<a href="#" class="disabled-lick"><i class="fa-solid fa-file-pen ms-3"></i> 수정</a>
						<a href="#" class="disabled-lick"><i class="fa-solid fa-trash-can ms-3"></i> 삭제</a>
					</c:if>
					</span>
				</h3>
				<hr>
